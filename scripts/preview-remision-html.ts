...
const html = renderRemisionVentaHTML({
  remision: {
    ...
    factura_numero: "FAC-000005",
    factura_cdc: "01801679389001002000000520260819112934481",
    factura_estado_sifen: "generado",
...
console.log("OK  borde negro: " + html.includes("#111827"));
console.log("OK  interior gris: " + html.includes("#4B5563"));
console.log("OK  sin rojo: " + !html.includes("#C7202A"));
