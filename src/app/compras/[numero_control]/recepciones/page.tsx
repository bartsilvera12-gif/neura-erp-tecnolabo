  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <PackageCheck className="h-7 w-7 text-[#4FAEB2]" />
        <div>
      ...
      {resumen && hayPendiente && (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          ...
          <div className="mt-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-2">
            ...
            <button onClick={() => registrar(true)} disabled={busy} className="inline-flex items-center justify-center gap-1.5 rounded-md bg-[#4FAEB2] px-5 py-2 text-sm font-medium text-white hover:bg-[#3F8E91] disabled:opacity-50">
                  ...
                  <tr key={r.id}>
                    ...
                    <td className="py-2.5 px-4 text-right">
                      <div className="inline-flex items-center gap-3">
                        ...
                        {r.estado === "borrador" && (
                          <button onClick={() => accionRecepcion(r.id, "confirmar")} disabled={busy} className="text-xs font-semibold text-[#3F8E91] hover:underline disabled:opacity-50">
                            Confirmar
                          </button>
                        )}
                        {r.estado === "confirmada" && (
