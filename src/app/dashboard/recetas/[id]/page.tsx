...
// Instancias con receta simplificada. Tecnolabo usa el modo completo, igual que
// el ERP fuente; no se heredan los schemas de otros clientes.
const SCHEMAS_RECETA_SIMPLE: readonly string[] = [];
const RECETA_SIMPLE = SCHEMAS_RECETA_SIMPLE.includes(NEURA_CLIENT_SCHEMA);
