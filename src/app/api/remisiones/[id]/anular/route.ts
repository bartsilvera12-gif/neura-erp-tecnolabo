...
import { anularRemision } from "@/lib/ventas/server/remisiones-pg";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    await anularRemision(schema, ctx.auth.empresa_id, id, {
    ...
    console.error("[/api/remisiones/[id]/anular]", msg);
