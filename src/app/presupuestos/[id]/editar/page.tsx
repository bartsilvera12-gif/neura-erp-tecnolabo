  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2">
        ...
        <button onClick={guardar} disabled={!valido || guardando} className="inline-flex items-center justify-center gap-1.5 rounded-md bg-[#1E2125] px-5 py-2 text-sm font-medium text-white hover:bg-[#17191C] disabled:opacity-50">
