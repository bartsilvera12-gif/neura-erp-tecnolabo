    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <LogOut className="h-7 w-7 text-[#1E2125]" />
          <div>
        ...
        <button onClick={() => setMostrarForm((v) => !v)} className="inline-flex items-center gap-1.5 rounded-md bg-[#1E2125] px-4 py-2 text-sm font-medium text-white hover:bg-[#17191C]">
      ...
      {mostrarForm && (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 space-y-4">
          ...
          <div className="flex flex-wrap items-end gap-2">
            ...
            <button type="button" onClick={agregar} disabled={!sel} className="inline-flex items-center gap-1 rounded-md bg-[#1E2125] px-3 py-2 text-sm font-medium text-white hover:bg-[#17191C] disabled:opacity-50">
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2">
            ...
            <button onClick={() => guardar(true)} disabled={busy} className="inline-flex items-center justify-center gap-1.5 rounded-md bg-[#1E2125] px-5 py-2 text-sm font-medium text-white hover:bg-[#17191C] disabled:opacity-50">
                  ...
                  <tr key={n.id}>
                    ...
                    <td className="py-2.5 px-4 text-right">
                      <div className="inline-flex items-center gap-3">
                        ...
                        {n.estado === "borrador" && <button onClick={() => accion(n.id, "confirmar")} disabled={busy} className="text-xs font-semibold text-[#17191C] hover:underline disabled:opacity-50">Confirmar</button>}
