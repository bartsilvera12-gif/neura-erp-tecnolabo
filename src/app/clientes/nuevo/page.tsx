 ...
 *
 * Tecnolabo usa el formulario completo, igual que el ERP fuente. Para simplificarlo
 * hay que agregar el schema propio a esta lista; no se heredan los schemas de otros
 * clientes.
 */
