...
/**
 * Instancias monocliente con formulario/detalle de clientes simplificado (sin campos
 * SaaS/Neura). Tecnolabo usa el detalle completo, igual que el ERP fuente; no se
 * heredan los schemas de otros clientes.
 */
const SCHEMAS_CLIENTE_SIMPLE: readonly string[] = [];
const SIMPLE_CLIENTE = SCHEMAS_CLIENTE_SIMPLE.includes(NEURA_CLIENT_SCHEMA);
// ── Estilos ────────────────────────────────────────────────────────────────────
