...
export default function MobileFab({ href, label, bottomOffset = "bottom-20" }: Props) {
  return (
    <Link
      href={href}
      className={`fixed right-4 ${bottomOffset} z-30 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#1E2125] text-white shadow-lg shadow-[#1E2125]/40 transition-all active:scale-95 active:bg-[#17191C] lg:hidden`}
      aria-label={label}
      title={label}
    >
